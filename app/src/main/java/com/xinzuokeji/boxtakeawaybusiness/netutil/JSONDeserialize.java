...
public class JSONDeserialize<T extends Serializable> {
    ...
    //类所在的包名
    private static final String CLASS_PACKAGE_NAME = "com.xinzuokeji.boxtakeawaybusiness.entities";
    ...
    private void setObjectValue(Object object, Field field, JSONObject jsonObject) throws Exception {
        ...
        if (!jsonObject.isNull(fieldName)) {
            ...
            //浮点数
                ...
                //字段名定义必须和类名相同
                Class<?> subType = Class.forName(CLASS_PACKAGE_NAME + "." + field.getName());
