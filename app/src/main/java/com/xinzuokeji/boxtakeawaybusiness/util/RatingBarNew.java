...
public class RatingBarNew extends LinearLayout {
    /**
     * 是否可点击
     */
     ...
     * 获取xml中设置的资源文件
     */
    public RatingBarNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.HORIZONTAL);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.RatingBar_starImageSize, 15);
        starPadding = mTypedArray.getDimension(R.styleable.RatingBar_starPadding, 15);
    ...
    private ImageView getStarImageView() {
        ...
        layout.setMargins(0, 0, Math.round(starPadding), 10);//设置每颗星星在线性布局的间距
