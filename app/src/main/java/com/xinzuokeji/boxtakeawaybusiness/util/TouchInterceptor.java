...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        super(context, attrs);
        @SuppressLint("WrongConstant") SharedPreferences pref = context.getSharedPreferences("Music", 3);
...
//                    View dragger = item.findViewById(R.id.tv_ceshji);//..........................
                    Rect r = mTempRect;
...
//        v.setBackgroundColor(backGroundColor);
    ...
    private void stopDragging() {
        if (mDragView != null) {
            @SuppressLint("WrongConstant") WindowManager wm = (WindowManager)getContext().getSystemService("window");
