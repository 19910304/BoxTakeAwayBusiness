...
public class Me extends Fragment implements View.OnClickListener {
    ...
    private void initView(View view, LayoutInflater inflater, ViewGroup container) {
        ...
        if (user_phone.equals("15736516568")) {
...
//        crl_information.setOnLoadMoreListener(this);
    ...
    private void me() {
        ...
        if (s == 1 || s == 2 || s == 3 || s == 4 || s == 19 || s == 20 || s == 21 || s == 22 || s == 23) {
            str = "晚上好";
        } else if (s == 12 || s == 13 || s == 14 || s == 15 || s == 16 || s == 17 || s == 18) {
            str = "下午好";
        } else {
            str = "早上好";
        }
...
//        final AudioManager audioMgr = (AudioManager) getInstance().getSystemService(Context.AUDIO_SERVICE);
//        // 获取最大音乐音量
...
//        AssetFileDescriptor file = getResources().openRawResourceFd(R.raw.like);
//        try {
...
//                        mediaPlayer.start();
//                        //调整音量 curVolume为音量值
//                        audioMgr.setStreamVolume(AudioManager.STREAM_MUSIC, 5,
